...
> [!WARNING]
> This project is shutdown, because I'm unable to cover its costs due to my unemployment, it stems from 10 to 20 dollars monthly.
> I've tried to cut some corners (and it was a good idea to implement free proxies and rotate them), but nothing is utimately free even on free tier.
> Hence, I'm no longer maintaining this project.
